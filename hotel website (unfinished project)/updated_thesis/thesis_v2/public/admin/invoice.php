    ...
    <table width="100%" id="table1" class="advancedtable" border="0" cellspacing="0" cellpadding="0">
		 <thead>
		   <tr>
			...
			<?php $guests=View_Total_Charges::find_all();?>
				<tbody>
				<?php foreach($guests as $guest): ?>
				   <tr>
						 ...
						 <td><?php echo $guest->total_charges; ?></td>						 
						 <td><a href='print_invoice.php?id=<?php echo $guest->id; ?>' target='_blank'>Print Invoice</a></td>
				   </tr>
				   <?php endforeach; ?>
				</tbody>
     </table>
