...
title="Guests" url="../crud_php/transact_charges_crud/get_transact_charges.php" toolbar="#toolbar" rownumbers="true" fitColumns="true" singleSelect="true">
		<thead>
			<tr>
				<th width="35" nowrap field="Room">Room</th>
				<th width="25" nowrap field="Room rate">Rate</th>
				<th width="50" nowrap field="Guestname">Guest</th>
				<th width="40" nowrap field="Arrival">Check in</th>
				<th width="40" nowrap field="Departure">Check out</th>
				<th width="40" nowrap field="Room charge">Charge</th>
				<th width="50" nowrap field="Additional Charges">Add Charges</th>
				<th width="50" nowrap field="Amount Due">Amount Due</th>				
			</tr>
		</thead>
</table>
	<div id="toolbar">
...
title="Guests" url="../crud_php/transact_payments_crud/get_transact_payments.php" toolbar="#toolbar1" rownumbers="true" fitColumns="true" singleSelect="true">
		<thead>
			<tr>
				...
				<th width="70" nowrap field="Guestname">Guest</th>
				<th width="50" nowrap field="Arrival">Arrival</th>
				<th width="50" nowrap field="Departure">Departure</th>
				<th width="50" nowrap field="Room_charge">Room charge</th>
				<th width="45" nowrap field="Additional_charges">Charges</th>
				<th width="50" nowrap field="Amount_due">Amount Due</th>
				<th width="50" nowrap field="Payments">Payments</th>
				<th width="50" nowrap field="Balance_due">Balance</th>
			</tr>
		</thead>
</table>
	<div id="toolbar1">
