...
<img src="" alt="Jampason Resort"name="Insert_logo"width="20%" height="90" id="Insert_logo" style="background: #8090AB; display:block;" />
	<div class="sidebar1">
	<p>Check in date:
	  <input type="text" id="checkindatepicker"></br>
	  Check out date:<input type="text" id="checkoutdatepicker"></br>
	  <label for="room">Type of Room: </label>
	  <br/>
	  <select name="room">
	    <option>Select One</option>
	    <?php foreach($rooms as $room):?>
	    <option value="<?php echo $room->id;?>"><?php echo $room->type_of_room; ?></option>
	    <?php endforeach;?>
	    </select>
	  </br>
	  </p>
          ...
          <ul class="ad-thumb-list">
            ...
            <li>
              <a href="images/11.jpg">
                <img src="images/thumbs/t11.jpg" title="A title for 11.jpg" alt="Description here." class="image2">
              </a>
            </li>
            <li>
              <a href="images/12.jpg">
                <img src="images/thumbs/t12.jpg" title="A title for 12.jpg" alt="Description here." class="image3">
              </a>
            </li>
            <li>
