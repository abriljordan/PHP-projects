...
class Guestlists extends DatabaseObject{
	protected static $table_name="guestlists";
	protected static $db_fields = array('room_id','roomtype_number', 'room');
	public $room_id;
	public $roomtype_number;
	public $room;
}
class BalanceDue extends DatabaseObject{
	protected static $table_name = "balance_due";
	protected static $db_fields = array('id','Room', 'Guestname','Arrival','Departure','Room_rate','Room_charge','Additional_charges','Amount_due','Payments','Balance_due');
	public $id;
	public $Room;
	public $Guestname;
	public $Arrival;
...
class Rate extends DatabaseObject{
	...
	protected static $db_fields = array('id', 'rate','description');
	public $id;
	public $description;
	public $rate;
...
class TransactCharges extends DatabaseObject{
	protected static $table_name="tmp_transact_charges_tbl";
	protected static $db_fields = array('id','guest_id','description','amount');
	public $id;
	public $guest_id;
	public $description;
	public $amount;
