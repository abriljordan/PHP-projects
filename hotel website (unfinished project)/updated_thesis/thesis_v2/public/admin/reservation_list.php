	...
	<div id="dlg" class="easyui-dialog" style="width:600px; height:550px; padding:10px 20px" closed="true" buttons="#dlg-buttons">
		...
		<fieldset>
					...
					<div class="fitem">
						...
						<input name="check_in_date" id="check_in_date" ><br/>
					</div>
					<div class="fitem">
						<label>Check out:</label>
						<input name="check_out_date" id="check_out_date" ><br/>
					</div>
					<div class="fitem">
			...
			<fieldset>
					<legend>In/Out</legend>
							<div class="fitem">
						<label>Check in: </label>
						<input name="check_in_date" id="checked_in_date" ><br/>
					</div>
					<div class="fitem">
						<label>Check out:</label>
						<input name="check_out_date" id="checked_out_date" ><br/>
					</div>					
			</fieldset>
		</form>
	</div>
