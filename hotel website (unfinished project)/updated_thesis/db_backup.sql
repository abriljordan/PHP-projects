...
--
-- Host: localhost
-- Generation Time: Feb 14, 2012 at 12:30 AM
...
(1, 1, 1, 1, '2012-02-13', 1, 1, '2012-02-20', '2012-02-25', '0000-00-00', '0000-00-00'),
(2, 2, 2, 1, '2012-02-13', 1, 1, '2012-02-14', '2012-02-16', '0000-00-00', '0000-00-00'),
(3, 3, 3, 1, '2012-02-13', 1, 1, '2012-02-20', '2012-02-25', '0000-00-00', '0000-00-00'),
(11, 4, 12, 0, '2012-02-13', 0, 1, '0000-00-00', '0000-00-00', '0000-00-00', '0000-00-00'),
(12, 4, 13, 1, '2012-02-13', 1, 1, '0000-00-00', '0000-00-00', '0000-00-00', '0000-00-00'),
(13, 3, 14, 1, '2012-02-13', 1, 0, '0000-00-00', '0000-00-00', '0000-00-00', '0000-00-00'),
(14, 2, 15, 1, '2012-02-13', 1, 1, '0000-00-00', '0000-00-00', '0000-00-00', '0000-00-00'),
(15, 2, 16, 1, '2012-02-13', 1, 1, '0000-00-00', '0000-00-00', '0000-00-00', '0000-00-00'),
(16, 3, 17, 1, '2012-02-13', 1, 1, '0000-00-00', '0000-00-00', '0000-00-00', '0000-00-00'),
(17, 1, 18, 1, '2012-02-13', 1, 1, '0000-00-00', '0000-00-00', '0000-00-00', '0000-00-00');
...
(1, 'abril jordan  ', 'casinillo', 'ajc@yahoo.com', '09261658756', 'gusa, cdoc'),
(2, 'stephanie', 'canete', 'pixai@yahoo.com', '09278170983', 'davao'),
(3, 'kimberly', 'canete', 'kim@yahoo.com', '12345678', 'davao'),
(4, 'roland', 'cambari', 'bobong@yahoo.com', '123', 'cugman'),
(5, 'allen', 'borja', 'allen@yahoo.com', '321', 'balulang'),
(6, 'eli', 'yares', 'yares@yahoo.com', '356', 'gusa'),
(7, 'jadel', 'badilla', 'jadel@yahoo.com', '789', 'bugo'),
(8, 'judith', 'marcaida', 'judith@yahoo', '456', 'gusa'),
(9, 'melanie', 'atienza', 'melai@yahoo.com', '456', 'kauswagan'),
(10, 'jelbeth', 'ramos', 'jelbeth@yahoo.com', '564', 'gusa'),
(11, 'rachel', 'valcorza', 'rachel@yahoo.com', '123', 'jasaan'),
(12, 'maricel', 'esclamado', 'maricel@gmail.com', '123', 'cdo'),
(13, 'maricel', 'esclamado', 'maricel@gmail.com', '321', 'cdo'),
(14, 'phillip', 'abamonga', 'abamonga@gmail.com', '789', 'cdo'),
(15, 'bryan', 'jugos', 'jugos@yahoo.com', '159', 'cdo'),
(16, 'lemuel', 'aduca', 'lemaduca@yahoo.com', '09261658756', 'cebu'),
(17, 'christian', 'labis', 'labis@yahoo.com', '09261658756', 'opol'),
(18, 'roland', 'cambari', 'bobong@yahoo.com', '857-6917', 'cugman');
...
(2, 1, 'Maintenance', 1, 1, 1, '2012-02-14', '2012-02-17', 1),
(3, 1, 'Plumbing', 1, 1, 1, '2012-02-16', '2012-02-18', 3);
...
(1, '1.jpg', 'image/jpeg', 376832, 'hello world!');
...
--
-- Stand-in structure for view `view_total_charges_v2`
--
DROP VIEW IF EXISTS `view_total_charges_v2`;
CREATE TABLE IF NOT EXISTS `view_total_charges_v2` (
`id` int(11)
,`guestname` varchar(511)
,`room` varchar(162)
,`check_in_date` date
...
--
-- Structure for view `view_total_charges_v2`
--
DROP TABLE IF EXISTS `view_total_charges_v2`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_total_charges_v2` AS select `guest`.`id` AS `id`,concat(`guest`.`first_name`,convert(repeat(' ',1) using latin1),`guest`.`last_name`) AS `guestname`,concat(`room`.`room_number`,'--',`roomtype`.`roomtype`) AS `room`,`booking`.`check_in_date` AS `check_in_date`,`booking`.`check_out_date` AS `check_out_date`,((((`booking`.`check_out_date` - `booking`.`check_in_date`) + 1) * `rate`.`rate`) + sum(`tmp_transact_charges_tbl`.`amount`)) AS `total_charges` from (((((`tmp_transact_charges_tbl` join `guest` on((`guest`.`id` = `tmp_transact_charges_tbl`.`guest_id`))) join `booking` on((`booking`.`guest_id` = `guest`.`id`))) join `room` on((`room`.`id` = `booking`.`room_id`))) join `roomtype` on((`roomtype`.`id` = `room`.`roomtype_id`))) join `rate` on((`rate`.`id` = `roomtype`.`rate_id`))) group by `rate`.`rate`,`roomtype`.`roomtype`,`room`.`room_number`,`guest`.`first_name`,`guest`.`last_name`,`booking`.`check_out_date`,`booking`.`check_in_date`,`guest`.`id` order by `guest`.`id`;
